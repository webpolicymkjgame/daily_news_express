          ...
          <div className="container header-container">
            <div className="header-left">
              <div className="logo-wrapper">
                <img src={logoImg} alt="Daily News Express" className="logo-img" />
                <span className="studio-name">Daily News Express</span>
              </div>
            </div>
...
function HomePage() {
  const apps = [
    {
      name: 'All Document Reader: PDF, DOC',
      image: bannerApp,
      link: 'https://play.google.com/store/apps/details?id=com.all.documentreader.viewer.filereader.office'
    }
  ];
      ...
      <section id="about" className="section about">
        <div className="container about-row">
          <div className="about-text-container">
            <h2 className="highlight-title">Daily News Express – Welcome Aboard</h2>
            <p className="about-text">Daily News Express is a forward-thinking mobile app studio committed to crafting innovative, dependable, and easy-to-use applications. Our mission is to blend creativity with functionality, delivering solutions that span across casual gaming, productivity, lifestyle, and education. Each app we develop is carefully designed with user experience in mind — offering intuitive navigation, thoughtful details, and practical value — to make everyday life simpler, smarter, and more enjoyable for users around the globe.
            </p>
          </div>
    ...
    <Router>
      <div className="App">
        ...
        <footer className="footer">
          <div className="container text-center">
            <p>&copy; {new Date().getFullYear()} Daily News Express. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </Router>
